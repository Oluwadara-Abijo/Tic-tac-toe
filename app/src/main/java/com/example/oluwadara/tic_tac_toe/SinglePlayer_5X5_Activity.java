...
public class SinglePlayer_5X5_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_player_5x5);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 1) {
                    Intent threeByThree = new Intent(SinglePlayer_5X5_Activity.this, SinglePlayer_3X3_Activity.class);
                    finish();
    ...
    public void computerTurn() {
        ...
        Button[] allButtons = {b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12,
    ...
    public void gameOver() {
        ...
        if (s1.equals("X") && s1.equals(s2) && s1.equals(s3) && s1.equals(s4)) {
            Toast.makeText(SinglePlayer_5X5_Activity.this, "Player 1 wins!", Toast.LENGTH_LONG).show();
            playerOneScore += 5;
        ...
        if (s1.equals("O") && s1.equals(s2) && s1.equals(s3) && s1.equals(s4)) {
            Toast.makeText(SinglePlayer_5X5_Activity.this, "Player 2 wins!", Toast.LENGTH_LONG).show();
            playerTwoScore += 5;
        ...
        if (!s1.equals("") && !s2.equals("") && !s3.equals("") && !s4.equals("") && !s5.equals("") && !s6.equals("")
            ...
            Toast.makeText(SinglePlayer_5X5_Activity.this, "Game Over! No winner.", Toast.LENGTH_LONG).show();
            endGame = true;
        }
