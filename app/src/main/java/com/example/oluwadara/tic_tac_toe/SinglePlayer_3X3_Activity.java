...
public class SinglePlayer_3X3_Activity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_player_3x3);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 2) {
                    Intent fiveByFive = new Intent(SinglePlayer_3X3_Activity.this, SinglePlayer_5X5_Activity.class);
                    finish();
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Check if cell has been clicked or not
    ...
    public void computerTurn() {
        ...
        Button[] allButtons = {b1, b2, b3, b4, b5, b6, b7, b8, b9};
        //Generate random button
        Random random = new Random();
        int randomNumber = random.nextInt(allButtons.length);
        Button randomButton = allButtons[randomNumber];
    ...
    public void gameOver() {
        ...
        if (s1.equals("X") && s1.equals(s2) && s1.equals(s3)) {
            Toast.makeText(SinglePlayer_3X3_Activity.this, "Player 1 wins!", Toast.LENGTH_LONG).show();
            playerOneScore += 5;
        ...
        if (s1.equals("O") && s1.equals(s2) && s1.equals(s3)) {
            Toast.makeText(SinglePlayer_3X3_Activity.this, "Player 2 wins!", Toast.LENGTH_LONG).show();
            playerTwoScore += 5;
        ...
        if (!s1.equals("") && !s2.equals("") && !s3.equals("") && !s4.equals("") && !s5.equals("")
            ...
            Toast.makeText(SinglePlayer_3X3_Activity.this, "Game Over! No winner.", Toast.LENGTH_LONG).show();
            endGame = true;
        }
